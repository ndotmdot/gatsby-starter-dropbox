...
function getTemporaryUrl(_x6, _x7) {
  return _getTemporaryUrl.apply(this, arguments);
}
/**
...
function _getTemporaryUrl() {
  _getTemporaryUrl = _asyncToGenerator(function* (dbx, path) {
...
function _processRemoteFile() {
  _processRemoteFile = _asyncToGenerator(function* ({
    ...
    if (datum.internal.type === TYPE_IMAGE || datum.internal.type === TYPE_MARKDOWN || datum.internal.type === TYPE_DEFAULT) {
      ...
      if (!fileNodeID) {
        try {
          const url = yield getTemporaryUrl(dbx, datum.dbxPath);
...
function createNodeData(data, options) {
  ...
  const fileNodes = files.map(file => {
    ...
    return _objectSpread({}, nodeDatum, {
      internal: {
  ...
  if (options.createFolderNodes) {
    ...
    folderNodes.push(_objectSpread({}, rootDatum, {
      internal: {
        type: TYPE_FOLDER,
...
exports.sourceNodes = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* ({
    ...
    const options = _objectSpread({}, defaultOptions, {}, pluginOptions);
