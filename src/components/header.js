    ...
    <header className="site-header">
      <div className="container">
        <div className="row">
          ...
          {/* {
            <a className="github-icon" href="X"> {gitHubIcon}</a>
          } */}
          {
            nav &&
